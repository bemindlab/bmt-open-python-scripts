...
from lib.agents.autogen import CodeAgent, ResearchAgent  # noqa: E402
...
def main() -> None:
    ...
    # สร้างข้อมูล CSV
    csv_data: List[List[Union[int, str, bool]]] = [
